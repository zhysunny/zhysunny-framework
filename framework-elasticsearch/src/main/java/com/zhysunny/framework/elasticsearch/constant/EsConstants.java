...
public class EsConstants extends Constants {
    ...
    public static final String ES_HISTORY_INDEX_NAME = CONF.getString("es.history.index.name");
    public static final String ES_HISTORY_INDEX_TYPE = CONF.getString("es.history.index.type");
