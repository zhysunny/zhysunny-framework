...
import com.zhysunny.framework.elasticsearch.thread.ElasticsearchDeleteThread;
 ...
 */
public class Feature246DeleteMain {
    ...
    public static void main(String[] args) {
        ...
        ElasticsearchService esDeleteService = new ElasticsearchDeleteFeature246ServiceImpl(
        ...
        for (File file : files) {
            ...
            threadPools.addThread(new ElasticsearchDeleteThread(name + num++, esDeleteService, input));
            if (num >= 5) {
                break;
            }
        }
